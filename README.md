...
`GET /api/feeds` (public catalog), `GET /api/feeds/{id}/episodes?season=`, `GET /api/feeds/{id}/seasons`,
`GET /api/episodes/{id}`, `GET /api/episodes/search?q=` (public read); `GET /api/me`, `GET/DELETE /api/me/identities`,
